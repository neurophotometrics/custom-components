...
namespace Neurophotometrics.CustomComponents
{
    partial class MasterController
    {
        ...
        private void InitializeComponent(Tuple<int, int> TitleControllerInitProps, Tuple<Tuple<int, bool[], int>, Tuple<bool[]>, Tuple<bool[,], bool[,], double[,], double[,]>> GlobalStatusControllerInitProps, Tuple<Tuple<int, bool[], int>, Tuple<bool[]>, Tuple<bool[,], bool[,], double[,], double[,]>> GraphListControllerInitProps)
        {
            ...
            this.titleController = new Neurophotometrics.CustomComponents.TitleController(TitleControllerInitProps);
            this.globalStatusController = new Neurophotometrics.CustomComponents.GlobalStatusController(GlobalStatusControllerInitProps);
            this.graphListController = new Neurophotometrics.CustomComponents.GraphListController(GraphListControllerInitProps);
