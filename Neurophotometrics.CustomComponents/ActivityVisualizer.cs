...
using System;
using ZedGraph;
using Neurophotometrics.CustomComponents;

[assembly: TypeVisualizer(typeof(ActivityVisualizer), Target = typeof(VisualizeROI))]
...
namespace Neurophotometrics.CustomComponents
{
    public class ActivityVisualizer : DialogTypeVisualizer
    {
         ...
         */
        static readonly double TargetElapsedTime = 1.0 / 15.0;
